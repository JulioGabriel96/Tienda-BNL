...
class StoreProductoRequest extends FormRequest
{
    ...
    {
        return [
            'codigo' => ['required', 'string', 'max:255', Rule::unique('productos', 'codigo')],
            'codigo_barra' => ['nullable', 'string', 'max:255', Rule::unique('productos', 'codigo_barra')],
    ...
    public function messages(): array
    {
        return [
            ...
            'stock_actual.required' => 'El stock actual inicial es obligatorio.',
