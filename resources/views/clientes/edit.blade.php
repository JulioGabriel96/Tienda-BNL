    ...
    <div class="col-lg-10">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-edit"></i> Formulario de Cliente</h5>
            </div>
                                ...
                                <select class="form-control @error('genero_id') is-invalid @enderror"
                                    ...
                                    @foreach ($generos as $genero)
                                        <option value="{{ $genero->id }}"
                                                {{ (string) old('genero_id', $cliente->genero_id) === (string) $genero->id ? 'selected' : '' }}>
                                            {{ $genero->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-control @error('tipo_cliente_id') is-invalid @enderror"
                                    ...
                                    @foreach ($tipoCliente as $tipo_cliente)
                                        <option value="{{ $tipo_cliente->id }}"
                                                {{ (string) old('tipo_cliente_id', $cliente->tipo_cliente_id) === (string) $tipo_cliente->id ? 'selected' : '' }}>
                                            {{ $tipo_cliente->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('estado') is-invalid @enderror"
                                        ...
                                        name="estado"
                                        required>
                                    <option value="" {{ old('estado', $cliente->estado) == '' ? 'selected' : '' }}>Seleccione un estado</option>
