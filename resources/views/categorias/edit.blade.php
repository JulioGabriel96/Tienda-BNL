                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                  ...
                                  style="resize: vertical;">{{ old('descripcion', $categoria->descripcion) }}</textarea>
                    ...
                    <div class="alert alert-info" role="alert">
                        <small>
                            <i class="bi bi-clock-history"></i> Creada el {{ $categoria->created_at->format('d/m/Y H:i') }}<br>
                            <i class="bi bi-arrow-repeat"></i> Última actualización {{ $categoria->updated_at->format('d/m/Y H:i') }}
                        </small>
                    </div>
                </div>
